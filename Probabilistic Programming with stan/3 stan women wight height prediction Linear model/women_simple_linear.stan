...
model{
  ...
  y~normal(x*alpha + beta, sigma); // likelihood of the model
  }
  
  
//generated quantities is Block for Posterior Predictive Check is for replicating data

generated quantities{
  // A quantity to be generated
  real y_rep[N];
  for(i in 1:N){
    y_rep[i] = normal_rng(x[i]*alpha + beta, sigma);   //define normal distribution for generated quantity as normal_rng
  }
